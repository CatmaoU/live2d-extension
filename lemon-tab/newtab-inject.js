...
(function() {
    ...
    function saveSettings(userConfig) {
        ...
        // 从用户配置读取模型源和是否使用 Cubism3，和普通网页保持一致
        var modelSource = userConfig.modelSource || 'local'; 
        var useCubism3 = userConfig.useCubism3 || false;
    ...
    browserAPI.storage.local.get([
        ...
        // 从用户配置读取是否使用 Cubism3，直接从 userConfig 读取避免作用域问题
        var currentUseCubism3 = userConfig.useCubism3 || false;
